...
const POLICIES: Record<string, { title: string; content: string }> = {
  privacy: {
    ...
    content: `
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Information We Collect</h2>
      ...
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">How We Use It</h2>
      ...
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Data Storage</h2>
      <p class="text-secondary mb-4">Data is stored securely with Supabase. Payment processing is handled by Razorpay.</p>
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Contact</h2>
  ...
  terms: {
    ...
    content: `
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Use of Service</h2>
      ...
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Account</h2>
      ...
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Changes</h2>
  ...
  refunds: {
    title: "Refund Policy",
    content: `
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">No Refunds</h2>
      ...
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Before Purchase</h2>
      ...
      <h2 class="text-xl font-bold text-charcoal mt-6 mb-2">Technical Issues</h2>
  ...
  return (
    <div className="py-16 px-4 sm:px-6">
      <div className="max-w-[700px] mx-auto">
        ...
        <h1 className="text-3xl font-bold text-charcoal mb-8">{policy.title}</h1>
        <div
