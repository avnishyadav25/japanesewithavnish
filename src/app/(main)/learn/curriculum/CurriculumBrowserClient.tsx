    ...
    <div className="space-y-8 max-w-[1100px] mx-auto">
      ...
      {modules.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Left Column: Module Card Navigation */}
          ...
          {/* Right Column: Module Lessons Details */}
          <div className="lg:col-span-8 bg-white rounded-2xl border border-[var(--divider)] p-6 shadow-sm">
            {(() => {
                    ...
                    {activeMod.submodules.length === 0 ? (
                      ...
                      activeMod.submodules.map((sub) => (
                        <div key={sub.id} className="space-y-3">
                          <h4 className="font-heading text-xs font-bold text-charcoal/80">
                          ...
                          <div className="space-y-3">
                            {sub.lessons.map((les) => {
                              ...
                              return (
                                <div
                                  key={les.id}
                                  className={`p-4 rounded-xl border bg-[#FAF8F5] flex flex-col gap-3 transition duration-200 ${
                                    isInProgress
