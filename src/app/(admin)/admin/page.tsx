...
export default async function AdminDashboardPage() {
  ...
  if (sql) {
    const [
      ...
      sql`SELECT COUNT(*)::int AS c FROM posts WHERE status = 'published' AND (content_type IS NULL OR content_type = 'blog')`,
      sql`SELECT COUNT(*)::int AS c FROM posts WHERE status = 'published' AND content_type IN ('grammar','vocabulary','kanji','reading','writing','listening','sounds','study_guide','practice_test')`,
